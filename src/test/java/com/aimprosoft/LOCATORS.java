...
String THE_CURRENT_AUTHORIZED_USER_NAME_IN_THE_LEFT_PANEL = "//div[@class]/p[@class='username'][contains(text(),'$1')]";
                                                            //"//div[@class]/p[@class='username']";
                                                            //"//div[@class]/p[@class='username'][contains(text(),'$1')]";
...
String ROOM_NAME_IN_THE_LEFT_PANEL = "//a[@class='room-link']//span[contains(text(), '$1')]";
...
String DESCRIPTION_INPUT_FIELD = "//textarea[@class='form-control undefined']";
...
String DESCRIPTION_TITLE_IN_THE_HEADER = "//div[@data-for='description'][contains(text(),'$1')]";
String DESCRIPTION_TITLE_IN_THE_TOP = "//div[@xpath='1'][contains(text(),'$1')]";
...
String INPUT_MESSAGE_FIELD = "//div[@class='chat-container active']//div[@role='textbox']";
...
String PREVIEW_TEXT_IN_A_SNIPPET = "//span[@class='file-name-text'][contains(text(),'$2')]//ancestor::div[@class='uploaded-file-wrapper edit-snippet']//span[contains(text(),'$1')]";
String RIGHT_CONTROL_HAMBURGER_ON_THE_SNIPPET = "//span[@class='file-name-text'][contains(text(),'$1')]//ancestor::div[@class='message-main-container']//div[@class='right-menu-btn']";
...
String DOWNLOAD_BUTTON_NEAR_SNIPPET_NAME = "//div[@class='file-name']/span[contains(text(),'test_snippet33.html')]//ancestor::div[@class='file-container']//i[contains(@class,'material-icons md-24 md-dark')][contains(text(),'file_download')]";
...
String MESSAGE_IN_THE_PINNED_ITEMS = "//div[@class='tab-content-header clearfix']//span[contains(text(),'Pinned messages')]//ancestor::div[@class='b-tab-content']//span[@class='LinkifyPlus'][contains(text(),'$1')]";
...
String DOWNLOAD_LINK_ON_A_FILE_IN_THE_RIGHT_PANEL = "//div[@class='pinned-message-item']//div[@class='file-name'][contains(text(),'$1')]//ancestor::div[@class='pinned-message-item']//a[text()='Download']";
...
String ROOM_NAME_TITLE_IN_THE_TOP_OF_A_ROOM = "(//div[@class='channel-name room-public'][contains(text(),'$1')])[1]";
